...
urlpatterns = [
    ...
    path('categories/', views.categories_view, name="list_categories"),
    path('suppliers/', views.suppliers_view, name="list_suppliers"),
    path('storehouses/', views.storehouses_view, name="list_storehouses"),
]
